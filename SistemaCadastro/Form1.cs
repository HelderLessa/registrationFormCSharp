    ...
    public partial class Form1 : Form
    {
        ...
        private void btnCadastrar_Click(object sender, EventArgs e)
        {
            ...
            foreach (Pessoa pessoa in pessoas)
            {
                ...
                {
                    index = pessoas.IndexOf(pessoa); // sobrescreverá o index já existente de p no index atual (para evitar repetição de pessoas)
                }
            }
            ...
            {
                pessoas[index] = p; // usado para alterar dados de uma pessoa já cadastrada
            }
